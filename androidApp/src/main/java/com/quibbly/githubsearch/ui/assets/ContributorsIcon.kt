...
val Icons.ContributorsIcon: ImageVector
    get() {
        if (_contributorsIcon != null) {
            return _contributorsIcon!!
        }
        _contributorsIcon = Builder(name = "ContributorsIcon", defaultWidth = 24.0.dp, defaultHeight
...
private var _contributorsIcon: ImageVector? = null
